...
The `ColorDetection.swift` script describes the class ColorDetector containing all the function linked to the color detection feature. 
...
The `TextDetection.swift` script is describes the class TextDetector containing all the function linked to the text detection feature. 
